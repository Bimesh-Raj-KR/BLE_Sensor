...
CPP project to Stream Live Video and share it to other IPs using a **Stream Uri** gotten and verified using Device discovery and **Onvifclient, Rtspclient and Gstreamer libraries.**
