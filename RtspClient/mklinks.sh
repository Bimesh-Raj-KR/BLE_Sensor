...
if [ ! -f $CUR/sdl/lib/linux/libSDL2-2.0.so.0 ]; then 
ln -s $CUR/sdl/lib/linux/libSDL2-2.0.so.0.14.0 $CUR/sdl/lib/linux/libSDL2-2.0.so.0
fi

if [ ! -f $CUR/sdl/lib/linux/libSDL2.so ]; then 
ln -s $CUR/sdl/lib/linux/libSDL2-2.0.so.0.14.0 $CUR/sdl/lib/linux/libSDL2.so
fi
